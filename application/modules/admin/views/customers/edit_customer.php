          <div class="padd">
			...
			$other_names = $customers[0]->other_names;
			$phone = $customers[0]->phone;
			$address = $customers[0]->address;
			$post_code = $customers[0]->post_code;
			$city = $customers[0]->city;
			$activated = $customers[0]->activated;
            ...
            <?php echo form_open('edit-customer/'.$customer_id, array("class" => "form-horizontal", "role" => "form"));?>
            <!-- First Name -->
