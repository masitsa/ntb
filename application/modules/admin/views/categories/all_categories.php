		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				if($category_status == 0)
				{
					...
					$button = '<a class="btn btn-info" href="'.site_url().'admin/activate-category/'.$category_id.'" onclick="return confirm(\'Do you want to activate '.$category_name.'?\');">Activate</a>';
				}
				//create activated status display
				else if($category_status == 1)
				{
					$status = '<span class="label label-success">Active</span>';
					$button = '<a class="btn btn-info" href="'.site_url().'admin/deactivate-category/'.$category_id.'" onclick="return confirm(\'Do you want to deactivate '.$category_name.'?\');">Deactivate</a>';
				}
				...
				'
					<tr>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="'.site_url().'admin/edit-category/'.$category_id.'" class="btn btn-sm btn-success">Edit</a>
											'.$button.'
											<a href="'.site_url().'admin/delete-category/'.$category_id.'" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete '.$category_name.'?\');">Delete</a>
										</div>
									</div>
								</div>
							</div>
						...
						<td><a href="'.site_url().'admin/edit-category/'.$category_id.'" class="btn btn-sm btn-success">Edit</a></td>
						<td>'.$button.'</td>
						<td><a href="'.site_url().'admin/delete-category/'.$category_id.'" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete '.$category_name.'?\');">Delete</a></td>
					</tr> 
				';
			}
