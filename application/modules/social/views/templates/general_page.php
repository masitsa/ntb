...
<head>
   	<?php echo $this->load->view('social/includes/header', '', TRUE); ?>
</head>
<body>
    ...
    <div class="st-container">
        ...
        <!-- top navi gation -->
        	<?php echo $this->load->view('social/includes/top_navigation', '', TRUE); ?>
        <!-- end of top navigation -->

        <!-- side bar -->
        	<?php echo $this->load->view('social/includes/side_bar', '', TRUE); ?>
        <!-- end of side bar -->

        <!-- speed bar -->
        	<?php echo $this->load->view('social/includes/speed_bar', '', TRUE); ?>
        <!-- speed bar -->
        ...
        <!-- Footer -->
       	<?php echo $this->load->view('social/includes/footer', '', TRUE); ?>
        <!-- // Footer -->
    </div>
    <!-- /st-container -->
