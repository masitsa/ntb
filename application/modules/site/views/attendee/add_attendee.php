 <div class="container-fluid">
 	...
 	<div class="col-md-12 col-lg-12">
     	...
     	<div class="col-md-12 col-lg-12" style="margin-bottom:5px;">
	 		 <a href="<?php echo site_url().'all-attendees/'.$meeting_id;?>" class="btn btn-info btn-sm">Back to attendees</a>
				...
				?>
					...
					<div class="row center-align">
						<div class="col-md-offset-5 col-sm-12">
							<button type="submit" class="btn btn-primary btn-sm"><?php echo $title;?> attendee</button>
						</div>
					</div>
				</div>
				<?php echo form_close();?>
